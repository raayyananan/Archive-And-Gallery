...
export const collections: Collection[] = [
    ...
    }, 
    {
        ...
        name: names[3],
        sources: [
            'assets/images/Overwhelmed/1.png',
            'assets/images/Overwhelmed/2.png',
            'assets/images/Overwhelmed/3.png',
            'assets/images/Overwhelmed/4.png',
            'assets/images/Overwhelmed/5.png',
            'assets/images/Overwhelmed/6.png',
            'assets/images/Overwhelmed/7.jpg',
            'assets/images/Overwhelmed/8.png',
            'assets/images/Overwhelmed/9.png',
            'assets/images/Overwhelmed/10.png',
        ]
    },
    {
        url: URLify(names[4]),
    ...
    }, 
    {
        ...
        name: names[5],
        sources: [
            'assets/images/Editorial Mimicry/1.png',
            'assets/images/Editorial Mimicry/2.png',
            'assets/images/Editorial Mimicry/3.png',
            'assets/images/Editorial Mimicry/4.png',
            'assets/images/Editorial Mimicry/5.png',
            'assets/images/Editorial Mimicry/6.png',
            'assets/images/Editorial Mimicry/7.png',
            'assets/images/Editorial Mimicry/8.png',
            'assets/images/Editorial Mimicry/9.png',
            'assets/images/Editorial Mimicry/10.png',
            'assets/images/Editorial Mimicry/11.png',
            'assets/images/Editorial Mimicry/12.png',
        ]
    },
    {
        url: URLify(names[6]),
